...
FCKScriptLoader.AddScript( 'FCKSessionConstants' ) ;
...
FCKScriptLoader.AddScript( 'FCKKeystrokeHandler', 'classes/'	, ['FCKSessionConstants','FCKBrowserInfo','FCKTools'], FCK_GENERIC ) ;
FCKScriptLoader.AddScript( 'FCKStyle'			, 'classes/'	, ['FCKSessionConstants','FCKDomRange','FCKDomRangeIterator','FCKDomTools','FCKListsLib','FCK_Xhtml10Transitional'], FCK_GENERIC ) ;
...
FCKScriptLoader.AddScript( 'FCKConfig'			, 'internals/'	, ['FCKBrowserInfo','FCKSessionConstants'] ) ;
