...
// 
namespace LuyenTriNho.GameServices {
    ...
    public interface GameServicesSoap {
        ...
        System.IAsyncResult BeginUpdateScore(LuyenTriNho.GameServices.UpdateScoreRequest request, System.AsyncCallback callback, object asyncState);
        
        LuyenTriNho.GameServices.UpdateScoreResponse EndUpdateScore(System.IAsyncResult result);
    ...
    public partial class UpdateScoreRequest {
        ...
        public LuyenTriNho.GameServices.UpdateScoreRequestBody Body;
        
        public UpdateScoreRequest() {
        }
        
        public UpdateScoreRequest(LuyenTriNho.GameServices.UpdateScoreRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class UpdateScoreResponse {
        ...
        public LuyenTriNho.GameServices.UpdateScoreResponseBody Body;
        
        public UpdateScoreResponse() {
        }
        
        public UpdateScoreResponse(LuyenTriNho.GameServices.UpdateScoreResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface GameServicesSoapChannel : LuyenTriNho.GameServices.GameServicesSoap, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class GameServicesSoapClient : System.ServiceModel.ClientBase<LuyenTriNho.GameServices.GameServicesSoap>, LuyenTriNho.GameServices.GameServicesSoap {
        ...
        System.IAsyncResult LuyenTriNho.GameServices.GameServicesSoap.BeginUpdateScore(LuyenTriNho.GameServices.UpdateScoreRequest request, System.AsyncCallback callback, object asyncState) {
        ...
        private System.IAsyncResult BeginUpdateScore(string hash, int gameID, int score, System.AsyncCallback callback, object asyncState) {
            LuyenTriNho.GameServices.UpdateScoreRequest inValue = new LuyenTriNho.GameServices.UpdateScoreRequest();
            inValue.Body = new LuyenTriNho.GameServices.UpdateScoreRequestBody();
            inValue.Body.hash = hash;
            inValue.Body.gameID = gameID;
            inValue.Body.score = score;
            return ((LuyenTriNho.GameServices.GameServicesSoap)(this)).BeginUpdateScore(inValue, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        LuyenTriNho.GameServices.UpdateScoreResponse LuyenTriNho.GameServices.GameServicesSoap.EndUpdateScore(System.IAsyncResult result) {
            return base.Channel.EndUpdateScore(result);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        private int EndUpdateScore(System.IAsyncResult result) {
            LuyenTriNho.GameServices.UpdateScoreResponse retVal = ((LuyenTriNho.GameServices.GameServicesSoap)(this)).EndUpdateScore(result);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult LuyenTriNho.GameServices.GameServicesSoap.BeginGetChallengeID(int gameID, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetChallengeID(gameID, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        int LuyenTriNho.GameServices.GameServicesSoap.EndGetChallengeID(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetChallengeID(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((LuyenTriNho.GameServices.GameServicesSoap)(this)).BeginGetChallengeID(gameID, callback, asyncState);
        }
        
        private object[] OnEndGetChallengeID(System.IAsyncResult result) {
            int retVal = ((LuyenTriNho.GameServices.GameServicesSoap)(this)).EndGetChallengeID(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override LuyenTriNho.GameServices.GameServicesSoap CreateChannel() {
            return new GameServicesSoapClientChannel(this);
        }
        
        private class GameServicesSoapClientChannel : ChannelBase<LuyenTriNho.GameServices.GameServicesSoap>, LuyenTriNho.GameServices.GameServicesSoap {
            
            public GameServicesSoapClientChannel(System.ServiceModel.ClientBase<LuyenTriNho.GameServices.GameServicesSoap> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BeginUpdateScore(LuyenTriNho.GameServices.UpdateScoreRequest request, System.AsyncCallback callback, object asyncState) {
            ...
            public LuyenTriNho.GameServices.UpdateScoreResponse EndUpdateScore(System.IAsyncResult result) {
                object[] _args = new object[0];
                LuyenTriNho.GameServices.UpdateScoreResponse _result = ((LuyenTriNho.GameServices.UpdateScoreResponse)(base.EndInvoke("UpdateScore", _args, result)));
                return _result;
            }
