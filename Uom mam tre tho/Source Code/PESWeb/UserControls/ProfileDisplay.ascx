<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProfileDisplay.ascx.cs" Inherits="PESWeb.UserControls.ProfileDisplay" %>
<div class="avatar">
    <asp:LinkButton ID="ibDelete" runat="server" OnClick="ibDelete_Click" CssClass="uiButtonClose small"/>
    <a class="image" href="/Profiles/Profile.aspx?AccountID=<asp:Literal id='litAccountID' runat='server'></asp:Literal>">
    <asp:Image ImageAlign="Left" ID="imgAvatar" ImageUrl="~/images/ProfileAvatar/ProfileImage.aspx" runat="server" /></a>
    <div class="para">
