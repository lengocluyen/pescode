...
namespace SubSonic.Extensions
{
    public static class Objects
    {
        ...
        public static T ChangeTypeTo<T>(this object value, T defaulValue)
        {
            Type conversionType = typeof(T);
            try
            {
        ...
        public static bool SetPropertyDeleted(this object obj, object value)
        {
            return obj.SetPropertyValue("Deleted", value);
        }
        ...
        public static bool PrimaryKeyEquals(this object value, object criteria)
        {
            if (value is int)
            {
                return criteria.ChangeTypeTo<int>(int.MinValue) == (int)value;
            }

            if (value is long)
            {
                return criteria.ChangeTypeTo<long>(long.MinValue) == (long)value;
            }

            if (value is Guid)
            {
                return criteria.ChangeTypeTo<Guid>(Guid.Empty) == (Guid)value;
            }

            if (value is string)
            {
                return criteria.ToString() == value.ToString();
            }
