...
// 
namespace HocChuCai_2.GameServices {
    ...
    public interface GameServicesSoap {
        ...
        System.IAsyncResult BeginUpdateScore(HocChuCai_2.GameServices.UpdateScoreRequest request, System.AsyncCallback callback, object asyncState);
        
        HocChuCai_2.GameServices.UpdateScoreResponse EndUpdateScore(System.IAsyncResult result);
    ...
    public partial class UpdateScoreRequest {
        ...
        public HocChuCai_2.GameServices.UpdateScoreRequestBody Body;
        
        public UpdateScoreRequest() {
        }
        
        public UpdateScoreRequest(HocChuCai_2.GameServices.UpdateScoreRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class UpdateScoreResponse {
        ...
        public HocChuCai_2.GameServices.UpdateScoreResponseBody Body;
        
        public UpdateScoreResponse() {
        }
        
        public UpdateScoreResponse(HocChuCai_2.GameServices.UpdateScoreResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface GameServicesSoapChannel : HocChuCai_2.GameServices.GameServicesSoap, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class GameServicesSoapClient : System.ServiceModel.ClientBase<HocChuCai_2.GameServices.GameServicesSoap>, HocChuCai_2.GameServices.GameServicesSoap {
        ...
        System.IAsyncResult HocChuCai_2.GameServices.GameServicesSoap.BeginUpdateScore(HocChuCai_2.GameServices.UpdateScoreRequest request, System.AsyncCallback callback, object asyncState) {
        ...
        private System.IAsyncResult BeginUpdateScore(string hash, int gameID, int score, System.AsyncCallback callback, object asyncState) {
            HocChuCai_2.GameServices.UpdateScoreRequest inValue = new HocChuCai_2.GameServices.UpdateScoreRequest();
            inValue.Body = new HocChuCai_2.GameServices.UpdateScoreRequestBody();
            inValue.Body.hash = hash;
            inValue.Body.gameID = gameID;
            inValue.Body.score = score;
            return ((HocChuCai_2.GameServices.GameServicesSoap)(this)).BeginUpdateScore(inValue, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        HocChuCai_2.GameServices.UpdateScoreResponse HocChuCai_2.GameServices.GameServicesSoap.EndUpdateScore(System.IAsyncResult result) {
            return base.Channel.EndUpdateScore(result);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        private int EndUpdateScore(System.IAsyncResult result) {
            HocChuCai_2.GameServices.UpdateScoreResponse retVal = ((HocChuCai_2.GameServices.GameServicesSoap)(this)).EndUpdateScore(result);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult HocChuCai_2.GameServices.GameServicesSoap.BeginGetChallengeID(int gameID, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetChallengeID(gameID, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        int HocChuCai_2.GameServices.GameServicesSoap.EndGetChallengeID(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetChallengeID(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((HocChuCai_2.GameServices.GameServicesSoap)(this)).BeginGetChallengeID(gameID, callback, asyncState);
        }
        
        private object[] OnEndGetChallengeID(System.IAsyncResult result) {
            int retVal = ((HocChuCai_2.GameServices.GameServicesSoap)(this)).EndGetChallengeID(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override HocChuCai_2.GameServices.GameServicesSoap CreateChannel() {
            return new GameServicesSoapClientChannel(this);
        }
        
        private class GameServicesSoapClientChannel : ChannelBase<HocChuCai_2.GameServices.GameServicesSoap>, HocChuCai_2.GameServices.GameServicesSoap {
            
            public GameServicesSoapClientChannel(System.ServiceModel.ClientBase<HocChuCai_2.GameServices.GameServicesSoap> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BeginUpdateScore(HocChuCai_2.GameServices.UpdateScoreRequest request, System.AsyncCallback callback, object asyncState) {
            ...
            public HocChuCai_2.GameServices.UpdateScoreResponse EndUpdateScore(System.IAsyncResult result) {
                object[] _args = new object[0];
                HocChuCai_2.GameServices.UpdateScoreResponse _result = ((HocChuCai_2.GameServices.UpdateScoreResponse)(base.EndInvoke("UpdateScore", _args, result)));
                return _result;
            }
