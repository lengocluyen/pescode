...
// 
namespace Danh_Trong.GameServices {
    ...
    public interface GameServicesSoap {
        ...
        System.IAsyncResult BeginUpdateScore(Danh_Trong.GameServices.UpdateScoreRequest request, System.AsyncCallback callback, object asyncState);
        
        Danh_Trong.GameServices.UpdateScoreResponse EndUpdateScore(System.IAsyncResult result);
    ...
    public partial class UpdateScoreRequest {
        ...
        public Danh_Trong.GameServices.UpdateScoreRequestBody Body;
        
        public UpdateScoreRequest() {
        }
        
        public UpdateScoreRequest(Danh_Trong.GameServices.UpdateScoreRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class UpdateScoreResponse {
        ...
        public Danh_Trong.GameServices.UpdateScoreResponseBody Body;
        
        public UpdateScoreResponse() {
        }
        
        public UpdateScoreResponse(Danh_Trong.GameServices.UpdateScoreResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface GameServicesSoapChannel : Danh_Trong.GameServices.GameServicesSoap, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class GameServicesSoapClient : System.ServiceModel.ClientBase<Danh_Trong.GameServices.GameServicesSoap>, Danh_Trong.GameServices.GameServicesSoap {
        ...
        System.IAsyncResult Danh_Trong.GameServices.GameServicesSoap.BeginUpdateScore(Danh_Trong.GameServices.UpdateScoreRequest request, System.AsyncCallback callback, object asyncState) {
        ...
        private System.IAsyncResult BeginUpdateScore(string hash, int gameID, int score, System.AsyncCallback callback, object asyncState) {
            Danh_Trong.GameServices.UpdateScoreRequest inValue = new Danh_Trong.GameServices.UpdateScoreRequest();
            inValue.Body = new Danh_Trong.GameServices.UpdateScoreRequestBody();
            inValue.Body.hash = hash;
            inValue.Body.gameID = gameID;
            inValue.Body.score = score;
            return ((Danh_Trong.GameServices.GameServicesSoap)(this)).BeginUpdateScore(inValue, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Danh_Trong.GameServices.UpdateScoreResponse Danh_Trong.GameServices.GameServicesSoap.EndUpdateScore(System.IAsyncResult result) {
            return base.Channel.EndUpdateScore(result);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        private int EndUpdateScore(System.IAsyncResult result) {
            Danh_Trong.GameServices.UpdateScoreResponse retVal = ((Danh_Trong.GameServices.GameServicesSoap)(this)).EndUpdateScore(result);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult Danh_Trong.GameServices.GameServicesSoap.BeginGetChallengeID(int gameID, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetChallengeID(gameID, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        int Danh_Trong.GameServices.GameServicesSoap.EndGetChallengeID(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetChallengeID(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((Danh_Trong.GameServices.GameServicesSoap)(this)).BeginGetChallengeID(gameID, callback, asyncState);
        }
        
        private object[] OnEndGetChallengeID(System.IAsyncResult result) {
            int retVal = ((Danh_Trong.GameServices.GameServicesSoap)(this)).EndGetChallengeID(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override Danh_Trong.GameServices.GameServicesSoap CreateChannel() {
            return new GameServicesSoapClientChannel(this);
        }
        
        private class GameServicesSoapClientChannel : ChannelBase<Danh_Trong.GameServices.GameServicesSoap>, Danh_Trong.GameServices.GameServicesSoap {
            
            public GameServicesSoapClientChannel(System.ServiceModel.ClientBase<Danh_Trong.GameServices.GameServicesSoap> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BeginUpdateScore(Danh_Trong.GameServices.UpdateScoreRequest request, System.AsyncCallback callback, object asyncState) {
            ...
            public Danh_Trong.GameServices.UpdateScoreResponse EndUpdateScore(System.IAsyncResult result) {
                object[] _args = new object[0];
                Danh_Trong.GameServices.UpdateScoreResponse _result = ((Danh_Trong.GameServices.UpdateScoreResponse)(base.EndInvoke("UpdateScore", _args, result)));
                return _result;
            }
