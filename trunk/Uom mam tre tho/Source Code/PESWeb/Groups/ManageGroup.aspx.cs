...
namespace PESWeb.Groups
{
    public partial class ManageGroup : System.Web.UI.Page, IManageGroup
    {
        ...
        private void BuildJS()
        {
            ...
            _js.AppendLine("CKEDITOR.replace('" + txtDescription.ClientID + "',{extraPlugins : 'uicolor',uiColor: '#C1E8C1',skin:'kama',toolbar:[[ 'Bold', 'Italic', '-', 'NumberedList', 'BulletedList', '-', 'Link', 'Unlink' ]]});");
            _js.AppendLine("CKEDITOR.replace('" + txtBody.ClientID + "',{extraPlugins : 'uicolor',uiColor: '#C1E8C1',skin:'kama',toolbar:[[ 'Bold', 'Italic', '-', 'NumberedList', 'BulletedList', '-', 'Link', 'Unlink' ]]});");
