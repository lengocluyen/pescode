...
namespace PESWeb
{
    ...
    public class Pager : WebControl, IPostBackEventHandler, INamingContainer
    {
        ...
        {
            string templateCell = "<a class=\"PagerHyperlinkStyle Last\" href=\"{0}\" title=\"" + GoToLastClause + "\"> " + LastClause + " </a>";
        ...
        {
            string templateCell = "<a class=\"PagerHyperlinkStyle Back\" href=\"{0}\" title=\""
                + string.Format(BackToPageClause, CurrentIndex - 1) + "\"> " + PreviousClause + " </a>";
        ...
        {
            string templateCell = "<a class=\"PagerHyperlinkStyle Next\" href=\"{0}\" title=\""
                + string.Format(NextToPageClause, CurrentIndex + 1) + "\"> " + NextClause + " </a>";
            return String.Format(templateCell, Page.ClientScript.GetPostBackClientHyperlink(this, (CurrentIndex + 1).ToString()));
        }
